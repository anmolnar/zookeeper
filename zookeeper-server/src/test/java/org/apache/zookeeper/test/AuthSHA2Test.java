...
public class AuthSHA2Test extends AuthTest {
    ...
    public void testGenerateDigest() throws NoSuchAlgorithmException {
        Assert.assertEquals("super:wjySwxg860UATFtciuZ1lpzrCHrPeov6SPu/ZD56uig=",
                            DigestAuthenticationProvider.generateDigest("super:test"));
        Assert.assertEquals("super:Ie58Fw6KA4ucTEDj23imIltKrXNDxQg8Rwtu0biQFcU=",
                            DigestAuthenticationProvider.generateDigest("super:zookeeper"));
        Assert.assertEquals("super:rVOiTPnqEqlpIRXqSoE6+7h6SzbHUrfAe34i8n/gmRU=",
                            DigestAuthenticationProvider.generateDigest(("super:foo")));
        Assert.assertEquals("super:vs70GBagNcqIhGR4R6rXP8E3lvJPYhzMpAMx8ghbTUk=",
    ...
    public void testDigest() throws NoSuchAlgorithmException {
        ...
        Assert.assertEquals("456831beef3fc1500939995d7369695f48642664a02d5eab9d807592a08b2384",
        ...
        Assert.assertEquals("fcde2b2edba56bf408601fb721fe9b5c338d10ee429ea04fae5511b68fbf8fb9",
